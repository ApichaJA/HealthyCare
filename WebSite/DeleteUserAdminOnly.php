                ...
                <a class="navbar-brand page-scroll" href="indexAdmin.php">HealthyCare</a>
							...
							<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
									...
									<ul class="nav navbar-nav navbar-right">
											...
											<li>
													<a class="page-scroll" href="DeleteUser.php">DeleteUser</a>
											</li>
											<li>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="SaveDeleteUser.php" method="DELETE" class="login-form">
			                    	<div class="form-group">
			                    		<label class="sr-only" for="form-username">Email</label>
			                        	<input type="text" name="Email" placeholder="EmailUser..." class="form-Email form-control" id="Email" value="<?php echo $objResult["Email"];?>">
															</div>
